...
def create_lmdb_for_gopro():
    # folder_path = '/media/disk/ly/image_deblurring/NAFNet/NAFNet-test/datasets/HIDE/train/blur_crops'
    # lmdb_path = '/media/disk/ly/image_deblurring/NAFNet/NAFNet-test/datasets/HIDE/train/blur_crops.lmdb'

    # img_path_list, keys = prepare_keys(folder_path, 'png')
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # folder_path = '/media/disk/ly/image_deblurring/NAFNet/NAFNet-test/datasets/HIDE/train/sharp_crops'
    # lmdb_path = '/media/disk/ly/image_deblurring/NAFNet/NAFNet-test/datasets/HIDE/train/sharp_crops.lmdb'

    # img_path_list, keys = prepare_keys(folder_path, 'png')
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '/media/disk/ly/image_deblurring/NAFNet/NAFNet-test/datasets/RealBlur-J/train/sharp_crops'
    lmdb_path = '/media/disk/ly/image_deblurring/NAFNet/NAFNet-test/datasets/RealBlur-J/train/sharp_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '/media/disk/ly/image_deblurring/NAFNet/NAFNet-test/datasets/RealBlur-J/train/blur_crops'
    lmdb_path = '/media/disk/ly/image_deblurring/NAFNet/NAFNet-test/datasets/RealBlur-J/train/blur_crops.lmdb'
